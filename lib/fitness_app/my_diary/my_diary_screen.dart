import 'package:best_flutter_ui_templates/fitness_app/my_diary/more_policy.dart';
...
import 'my_customization_policy.dart';
    ...
    listViews.add(
      TitleView(
        ...
        onTap: (){
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => MyCustomizationPolicyScreen()),
          );
        },
      ),
    );
